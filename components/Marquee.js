...
export default function Marquee( {fullWidthMarquee} ) {
    const {fullWidthImage, fullWidthHeading, fullWidtEyebrow, fullWidthDescription } = recipe.fields
  return (
        ...
        <div className='info'>
          <div>New</div>
            <div>Eyebrow</div>
                ...
                <div className='marqueeDescription'> { documentToReactComponents(fullWidthDescription)} </div>
